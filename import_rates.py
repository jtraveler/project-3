...
def load_hs_codes():
    """
    Loads HS code data from the 'hs_codes' tab in the
    same Google Sheet. Returns a list of dictionaries with
    hs_code, description, and duty_rate.
    ...
    hs_sheet = GSPREAD_CLIENT.open(
        'code-institute-project3-import_rates'
        ).worksheet('hs_codes')
